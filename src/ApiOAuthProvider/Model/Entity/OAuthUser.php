...
/**
 * @ORM\Entity(repositoryClass="ApiOAuthProvider\Model\Repository\OAuthUserRepository")
...
class OAuthUser
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ApiOAuthProvider\Model\Entity\OAuthClient", mappedBy="userIds")
     */
    protected $clientIds;
