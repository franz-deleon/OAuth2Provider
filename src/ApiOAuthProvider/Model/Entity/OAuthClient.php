...
/**
 * @ORM\Entity(repositoryClass="ApiOAuthProvider\Model\Repository\OAuthClientRepository")
...
class OAuthClient
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ApiOAuthProvider\Model\Entity\OAuthUser", inversedBy="clientIds")
