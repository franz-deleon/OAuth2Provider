...
use ApiOAuthProvider\Service\Factory\ConfigurationFactory;
...
class ConfigurationFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateService()
    {
        ...
        $this->assertEquals('apioauthprovider.server.client', $configOption->getMainServer());
    }
    ...
    public function testCreateServiceWithMainServerEmptyValueShouldUseDefault()
    {
        ...
        $configOption = $this->ConfigurationFactory->createService($mainSm);
        $this->assertEquals('apioauthprovider.server.default', $configOption->getMainServer());
    }
